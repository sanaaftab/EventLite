...
public class EventsController {
	...
	public String createEvent(@RequestBody @Valid @ModelAttribute Event event,
		...
		public String postTweets(Model model) {
			if(!model.containsAttribute("twitterTimeline")) {
				try{
				
				twitterService.createTweet("This is an autogenerated tweet.");
				twitterService.createTweet("This is another autogenerated tweet!");
				model.addAttribute("twitterTimeline",twitterService.getTimeLine());
				
				}
				catch(TwitterException e) {
					log.info("Something went wrong when getting the Twitter Timeline.");
				}
			}
